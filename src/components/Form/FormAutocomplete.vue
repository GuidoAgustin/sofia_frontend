<template>
  <div class="form-container form-autocomplete" :id="'container_' + itemId" :class="{ disabled }">
    ...
    <div class="form-wrapper">
      ...
      />
      <ul class="search_results" :id="itemId + '_results'" v-if="searching && options.length">
...
export default {
  ...
  methods: {
    ...
    clickOutside(e) {
      const cont = document.body.querySelector(`#container_${this.itemId}`)

      if (!cont.contains(e.target) && this.searching) this.searching = false
    },
    onSearch() {
